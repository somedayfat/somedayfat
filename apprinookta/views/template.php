										...
										<div class="container">
											<div class="row align-items-center">
												<div class="col-lg-12 col-sm-12 mt-3 mt-lg-0 text-center">
													...
													<?php echo date('Y'); ?> Pantau Corona by <a href="https://instagram.com/somedayfat">Somedayfat</a>. Made with <i class="fa fa-heart"></i> by <a href="https://teguh.co" target="_blank">Teguh Aprianto</a>
												</div>
											</div>
										</div>
									</div>
